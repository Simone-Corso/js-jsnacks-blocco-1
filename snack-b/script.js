...
//Dobbiamo chiedere 7 cifre all'utente
// - creare sette prompt per chiedere 7 cifre

const primaCifra = prompt('Scrivimi la prima cifra');
const secondaCifra = prompt('Scrivimi la seconda cifra');
